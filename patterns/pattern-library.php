<?php
/**
 * Title: Pattern Library — Full Set
 * Slug: carlashub/pattern-library
 * Categories: carlashub-page-style
 * Keywords: patterns, library
 */
?>
<!-- wp:group {"className":"pattern-library","layout":{"type":"constrained"}} -->
<div class="wp-block-group pattern-library">
  <!-- wp:heading {"level":1} -->
  <h1>Pattern Library</h1>
  <!-- /wp:heading -->
  <!-- wp:paragraph -->
  <p>All core patterns in one place for review and reuse.</p>
  <!-- /wp:paragraph -->

  <!-- wp:separator {"className":"is-style-sigil"} /-->
  <!-- wp:pattern {"slug":"carlashub/hero-editorial-centered"} /-->
  <!-- wp:separator {"className":"is-style-sigil"} /-->
  <!-- wp:pattern {"slug":"carlashub/hero-split-framed"} /-->
  <!-- wp:separator {"className":"is-style-sigil"} /-->
  ...
  <!-- wp:pattern {"slug":"carlashub/portfolio-intro"} /-->
  ...
  <!-- wp:pattern {"slug":"carlashub/blog-query-cards"} /-->
